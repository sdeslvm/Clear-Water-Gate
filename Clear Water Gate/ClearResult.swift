...
enum ClearWebStatus: Equatable, WebStatusComparable {
    case standby
    ...
    func isEquivalent(to other: ClearWebStatus) -> Bool {
        switch (self, other) {
...
extension ClearWebStatus {
    static func == (lhs: ClearWebStatus, rhs: ClearWebStatus) -> Bool {
