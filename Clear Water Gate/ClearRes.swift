...
protocol WebLoadable: AnyObject {
    var state: ClearWebStatus { get set }
...
final class ClearWebLoader: NSObject, ObservableObject, WebLoadable, ProgressMonitoring {
    // MARK: - Свойства

    @Published var state: ClearWebStatus = .standby
...
extension ClearWebLoader: WKNavigationDelegate {
