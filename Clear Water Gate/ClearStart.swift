...
struct ClearWebViewBox: UIViewRepresentable {
    // MARK: - Свойства

    @ObservedObject var loader: ClearWebLoader

    // MARK: - Координатор

    func makeCoordinator() -> ClearWebCoordinator {
        ClearWebCoordinator { [weak loader] status in
