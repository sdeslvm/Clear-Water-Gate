...
class ClearWebCoordinator: NSObject, WKNavigationDelegate, WKUIDelegate {
    private let callback: (ClearWebStatus) -> Void
    private var didStart = false

    init(onStatus: @escaping (ClearWebStatus) -> Void) {
